        ...
        private void DrawMandelBW(PictureBox display)
        {
            for (int x = 0; x < display.Width; x++)
            {
                for (int y = 0; y < display.Height; y++)
                {
                    ...
                    double im2 = Math.Sin(Math.Sqrt(x * x + y * y)); // use a function to calculate z-value
        ...
        private void MethodOneRGB(PictureBox display)
        {
            for (int x = 0; x < display.Width; x++)
            {
                for (int y = 0; y < display.Height; y++)
                {
                    ...
                    double im2 = Math.Sin(Math.Sqrt(re * re + im1 * im1)); // use a function to calculate z-value
                    Cplx c = new Cplx(re, im1, im2);
